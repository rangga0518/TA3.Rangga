...
@section('content')
        ...
        <a href="{{URL('komentar/create')}}" class="btn btn-success">Tambah Komentar</a>
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{-- <a href="{{URL('komentar/'.$coment->id.'/edit')}}" class="btn btn-primary"><i class="fa fa-pencil"></i></a> --}}
                                    <form action="{{URL('komentar/'.$coment->id)}}" method="POST">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE')}}
