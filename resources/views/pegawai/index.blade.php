            ...
            <div class="card bg-primary p-20">
                <div class="media widget-ten">
                    ...
                    <div class="media-body media-text-right">
                        <a href="{{URL('pelanggan')}}"><h2 class="color-white">{{$dashboard['jumlah_pelanggan']}}</h2></a>
        ...
        {{-- <div class="col-md-3">
            <div class="card bg-pink p-20">
                <div class="media widget-ten">
                    ...
                    <div class="media-body media-text-right">
                        <a href="{{URL('pemesanan')}}"><h2 class="color-white">{{$dashboard['jumlah_pesanan']}}</h2></a>
        ...
        <div class="col-md-4">
            <div class="card bg-success p-20">
                <div class="media widget-ten">
                    ...
                    <div class="media-body media-text-right">
                        <a href="{{URL('reservasi')}}"><h2 class="color-white">{{$dashboard['jumlah_reservasi']}}</h2></a>
        ...
        <div class="col-md-4">
            <div class="card bg-danger p-20">
                <div class="media widget-ten">
                    ...
                    <div class="media-body media-text-right">
                        <a href="{{URL('hidangan')}}"><h2 class="color-white">{{$dashboard['jumlah_hidangan']}}</h2></a>
