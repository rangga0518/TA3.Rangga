            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img" class="img-circle">User<span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img" class="img-circle">User<span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img" class="img-circle">User<span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ Auth::user()->name }} <span class="caret"></span></a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav" style="background: #faebcd">
                    <ul id="sidebarnav">
                        ...
                        <li class="{{{(Request::is('reservasi') ? 'active' : '')}}}"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Reservasi</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('reservasi')}}">Semua Reservasi</a></li>
                                <li><a href="{{URL('reservasi/create')}}">Buat Reservasi</a></li>
                            </ul>
                        </li>
                        <li class="{{{(Request::is('about') ? 'active' : '')}}}"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-list-ul"></i><span class="hide-menu">About</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('about')}}">Semua About</a></li>
                                <li><a href="{{URL('about/create')}}">Buat About</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="{{{(Request::is('hidangan') ? 'active' : '')}}}"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-fire"></i><span class="hide-menu">Hidangan</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('hidangan')}}">Semua Hidangan</a></li>
                                <li><a href="{{URL('hidangan/create')}}">Tambah Hidangan</a></li>
                            </ul>
                        </li>
                        <li class="{{{(Request::is('restoran') ? 'active' : '')}}}"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-home"></i><span class="hide-menu">Restoran</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('restoran')}}">Semua Restoran</a></li>
                                <li><a href="{{URL('restoran/create')}}">Tambah Restoran</a></li>
                            </ul>
                        </li>
