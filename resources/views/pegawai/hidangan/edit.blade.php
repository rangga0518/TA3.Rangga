    ...
    <div class="card" style="background: #f5f5f5">
            <div class="basic-form">
                {{-- @foreach($hidangan as $hidangan) --}}
                    <form method="POST" action="{{URL('hidangan', $hidangan->id)}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('PATCH')}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group">
                                <img src="{{ Storage::url($hidangan->foto_hidangan) }}" alt="" style="width: 150px;">
                                <input type="file" name="foto_hidangan" id="foto_hidangan" class="form-control" value="{{ $hidangan }}">
                            </div>
                        </div>
